...
public class MainActivity extends ActionBarActivity implements HttpGetDataListener, View.OnClickListener {
    ...
    public String getTime() {
        ...
        SimpleDateFormat format = new SimpleDateFormat( "yyyy年MM月dd日 HH:ss" ) ;
    ...
    public void onClick(View view) {
        ...
        httpData = (HttpData) new HttpData( "http://www.tuling123.com/openapi/api?key=33f0bd6ab2e8f0dcb52a199395801049&info=" + droph ,
                this ).execute();
        adapter.notifyDataSetChanged();
